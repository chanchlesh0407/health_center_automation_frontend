      ...
      <div className="w-full max-w-[980px] bg-white border border-sky-100 shadow-xl shadow-sky-100/60 rounded-xl p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 bg-sky-50 border border-sky-200 rounded-lg px-3 py-2">
              <span className="text-sky-700 text-sm font-semibold">Filter</span>
            </div>
            <button type="button" className="px-4 py-2 bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white border border-sky-700 rounded-lg font-bold">Cancel</button>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {timeSlots.map(t => (
                      <button
                        ...
                        className={`px-3 py-2 rounded-md border text-sm ${appointmentTime === t ? 'bg-sky-600 text-white border-sky-700' : 'bg-white text-sky-900 border-sky-200 hover:bg-sky-50'}`}
                      >
                        {t}
                      </button>
                    ))}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button type="button" onClick={downloadReceipt} disabled={!patientName} className={`px-4 py-2 rounded-lg font-bold ${patientName ? 'bg-sky-600 hover:bg-sky-700 text-white' : 'bg-sky-300 text-white cursor-not-allowed'}`}>Download PDF</button>
